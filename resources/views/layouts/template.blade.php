...
<head>
  ...
  <title>Perpusku &mdash; SMK Wikrama Bogor</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="{{ (request()->is('reader*')) ? 'active' : '' }}"><a class="nav-link" href="{{route('reader.index')}}"><i class="fas fa-users"></i> <span>Reader</span></a></li>
              <li class="menu-header">Data Borrow</li>
              <li class="{{ (request()->is('borrow*')) ? 'active' : '' }}"><a class="nav-link" href="{{route('borrow.index')}}"><i class="fas fa-box"></i> <span>Borrow</span></a></li>
            </ul>
        </aside>
      </div>
